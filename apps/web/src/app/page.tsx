...
const AGENTS = [
  { name: "GitHub Copilot CLI", badge: "beforeTaskComplete hook", color: "text-blue-400" },
  { name: "Claude Code", badge: "Stop / PostToolUse hooks", color: "text-orange-400" },
  { name: "Cursor", badge: ".cursorrules injection", color: "text-purple-400" },
];
